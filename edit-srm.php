...
if(isset($_POST['submit']))
{
    ...
    $prevQuery = "SELECT * FROM srms WHERE srm_name = '".$srm->srm_name."'";
    ...
    if($prevResult->num_rows > 0){
        ...
        if(isset($_GET['id']) && $_GET['id']!=''){
            ...
            if($srm->id==$getData['id']){
            }else{
                $msg="SRM already available in the portal";
            }
        }else{
    ...
    $srm->save();
    redirect('srms.php');
    $session->message("SRM {$srm->srm_name} updated successfully.");
}
?>
    <div id="content" class="content">
        <ol class="breadcrumb float-xl-right">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
            <li class="breadcrumb-item"><a href="srms.php">SRMs</a></li>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Edit SRM</h4>
                            ...
                            <form class="form-horizontal" data-parsley-validate="true" method="post" action="">
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" value="<?=$srm->srm_name?>" id="srm_name" name="srm_name" placeholder="Required" data-parsley-required="true" />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
