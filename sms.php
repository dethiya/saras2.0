<?php
$page_title='Import SMS Register';
$upload_class='active';
$sms_class='active';
...
if(!empty($_GET['status'])){
    switch($_GET['status']){
        case    'succ':
            ...
            $statusMsg = 'SMS data has been imported successfully.';
            break;
        case 'err':
            $type='Error';
            ...
            <div class="col-xl-6">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body" id="importFrm" style="display: none;">
                        <form class="form-horizontal" data-parsley-validate="true" method="post" action="importSMS.php" enctype="multipart/form-data">
