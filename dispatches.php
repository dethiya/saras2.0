<?php
$page_title='Import Dispatches';
$upload_class='active';
$dispatch_class='active';
...
if(!empty($_GET['status'])){
    switch($_GET['status']){
        case 'succ':
            ...
            $statusMsg = 'Purchase records have been imported successfully.';
            break;
        case 'err':
            $type='Error';
            ...
            <div class="col-xl-6">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body" id="importFrm" style="display: none;">
                        <form class="form-horizontal" data-parsley-validate="true" method="post" action="importData.php" enctype="multipart/form-data">
