        ...
        if(is_uploaded_file($_FILES['file']['tmp_name'])){
            ...
            while(($line = fgetcsv($csvFile)) !== FALSE){
                ...
                if($prevResult->num_rows > 0){
                    ...
                    $database->query("UPDATE dispatches SET dms_inv_no='".$dms_inv_no."', dms_inv_dt='".$dms_inv_dt."' WHERE chassis_no = '".$chassis_no."' AND engine_no = '".$engine_no."'");
                }else{
...
header("Location: dms.php".$qstring);