...
$deliver_customer=DeliveryDatabase::find($_GET['id']);
$allotment=Stock::find($deliver_customer->vehicle_id);
...
if (isset($_POST['submit']))
{
    ...
    $deliver_customer->gatepass= $_POST['gatepass'];
    $deliver_customer->mobile_no=$_POST['mobile_no'];
    $deliver_customer->date_of_birth=$_POST['date_of_birth'];
    $deliver_customer->email_id=$_POST['email_id'];
    $deliver_customer->address=$_POST['address'];
    $deliver_customer->updated_by=$session->user_id;

    date_default_timezone_set('Asia/Kolkata');
    $date= date('Y-m-d');
    $time= date('H:i:s');
    $deliver_customer->updated_at=$date.' '.$time;

    $deliver_customer->save();
    redirect("delivery-register.php");
                ...
                <div class="col-xl-12">
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        <div class="panel-heading">
                            <h4 class="panel-title">Update Customer Details</h4>
                            ...
                            <form class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data" method="post" action="">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <input class="form-control" type="text" value="<?=$deliver_customer->gatepass?>" id="gatepass" name="gatepass" placeholder="Enter gatepass no." autofocus data-parsley-required="true" />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="mobile_no">Mobile No. :</label>
                                    <div class="col-md-4 col-sm-4">
                                        <input class="form-control" type="number" value="<?=$deliver_customer->mobile_no?>" id="mobile_no" name="mobile_no" placeholder="Enter mobile number"  />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="date_of_birth">Date of Birth. :</label>
                                    <div class="col-md-4 col-sm-4">
                                        <input class="form-control" type="date" value="<?=$deliver_customer->date_of_birth?>" id="date_of_birth" name="date_of_birth" placeholder=""  />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="email_id">Email Id :</label>
                                    <div class="col-md-4 col-sm-4">
                                        <input class="form-control" type="email" value="<?=$deliver_customer->email_id?>" id="email_id" name="email_id" placeholder="Enter email id."  />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="address">Address :</label>
                                    <div class="col-md-4 col-sm-4">
                                        <textarea name="address" id="address" class="form-control" cols="30" rows="5"><?=$deliver_customer->address?></textarea>
                                    </div>
                                </div>
