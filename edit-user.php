...
if(isset($_POST['submit']))
{
    ...
    if($prevResult->num_rows > 0){
        ...
        $user->save();
        redirect("users.php");
        $session->message("Employee {$user->employee_name} with {$user->username} updated successfully.");
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" data-parsley-validate="true" enctype="multipart/form-data" method="post" action="">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" value="<?=$user->username?>" id="username" name="username" placeholder="Required" data-parsley-required="true" />
                                    </div>
                                </div>
                               <div class="form-group row m-b-15">
