<?php 
    ...
    include 'includes/sidebar.php';
        ...
        $allotment=Stock::select('*','allot_status_id<>5 and delr in ("20NB","37NA","68NA")','allot_status_id ASC, model_code ASC, color ASC, invoice_dt DESC');
