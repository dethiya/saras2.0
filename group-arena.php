<?php 
    ...
    include 'includes/sidebar.php';
        ...
        $allotment=Stock::select('*','allot_status_id<>5 and delr in ("2002","3701","6801","P301")','allot_status_id ASC, model_code ASC, color ASC, invoice_dt DESC');
