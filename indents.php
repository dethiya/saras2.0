                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($value->dispatch==1){ ?>
                                        <a href="javascript:void(0)" receive="<?=$value->id?>" class="receive_link btn btn-warning btn-icon btn-sm"><i class="fa fa-sync fa-spin"></i></a>
                                    <?php }elseif($value->dispatch==0){?>
                                        <a href="" class="btn btn-secondary btn-icon btn-sm"><i class="fa fa-car"></i></a>
                                    <?php }else{ ?>
                                        <a href="" class="btn btn-success btn-icon btn-sm"><i class="fa fa-thumbs-up"></i></a>
                                    <?php };?>
                                        <button class="btn btn-warning btn-icon btn-sm btnCancelIndent" indent_id="<?=$value->id?>" chassis_no="<?=$get_vehicle_details->chassis_no?>">
                                ...
                                <td>
                                    ...
                                    if($value->dispatch==0){
                                        ...
                                        echo '<span class="label label-theme bg-success">Received</span>';
                                    }
                                    ?>
                                </td>
                                <td>
