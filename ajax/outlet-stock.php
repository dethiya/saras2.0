...
$sql.=' WHERE outlets.outlet_code=dispatches.delr and outlets.channel_id=channels.id and channels.id=1';
...
<td>'.$i.'</td>
<td>'.$row[0].'</td>
<td class="text-sm-center">'.$row[2].' <br>
    <span class="badge badge-gray">'
        .number_format(($row[2]/$row_total)*100,2).'% 
    </span>
</td>
<td class="text-sm-center">'.$row[3].' <br>
    <span class="badge badge-danger">'
        .number_format(($row[3]/$row_total)*100,2).'% 
    </span>
</td>
<td class="text-sm-center">'.$row[4].' <br>
    <span class="badge badge-orange">'
        .number_format(($row[4]/$row_total)*100,2).'% 
    </span>
</td>
<td class="text-sm-center">'.$row[5].' <br>
    <span class="badge badge-blue">'
        .number_format(($row[5]/$row_total)*100,2).'% 
    </span>
</td>
