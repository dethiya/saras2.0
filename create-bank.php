...
if(isset($_POST['submit']))
{
    ...
    if($prevResult->num_rows > 0){
        $message="{$bank->bank_name} with {$bank->bank_branch} Branch is already available in the portal";
    } else
    {
        $bank->save();
        redirect('banks.php');
        $session->message("New Bank {$bank->bank_name} with {$bank->bank_branch} created successfully.");
    }
}
?>
                            ...
                            <form class="form-horizontal" data-parsley-validate="true" method="post" action="">
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" id="bank_name" name="bank_name" placeholder="Required" data-parsley-required="true" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control" type="text" id="bank_branch" name="bank_branch" placeholder="Required" data-parsley-required="true" />
                                    </div>
                                </div>
